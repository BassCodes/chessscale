...
const ADJACENT_PIECES: Array<Array<Point>> = [
	[[1, 1],],
	[[1, 0],],
	[[1, -1],],
	[[0, 1],],
...
const DIAGONAL: Array<Array<Point>> = [
	// Up Left
	[[-1, -1],
		[-2, -2],
		[-3, -3],
...
const VERTICAL_HORIZONTAL: Array<Array<Point>> = [
	// Right
	[[1, 0],
		[2, 0],
		[3, 0],
...
const KNIGHT_MOVEMENT: Array<Array<Point>> = [
	[[2, 1],],
	[[2, -1],],
	[[-2, 1],],
	[[-2, -1],],
...
const VERTICAL_HORIZONTAL_DIAGONAL: Array<Array<Point>> = [];
